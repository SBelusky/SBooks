...
import com.sbelusky.spring_boot_library.dao.CheckoutRepository;
import com.sbelusky.spring_boot_library.dao.HistoryRepository;
import com.sbelusky.spring_boot_library.dao.PaymentRepository;
import com.sbelusky.spring_boot_library.entity.Book;
import com.sbelusky.spring_boot_library.entity.Checkout;
import com.sbelusky.spring_boot_library.entity.History;
import com.sbelusky.spring_boot_library.entity.Payment;
...
public class BookService {
    ...
    public Book checkoutBook(String userEmail, Long bookId) throws Exception {
        ...
        if (book.isEmpty() || validateCheckout != null || book.get().getCopiesAvailable() <= 0){
            throw new Exception("Book does not exist or already checkout out by user");
        }
